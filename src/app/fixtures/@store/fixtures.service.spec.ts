...
describe('FixturesService', () => {
  ...
  let storageSpy: { ref: Mock; };
  let mockLocalStorageService: { getFromLocalStorage: Mock, saveToLocalStorage: Mock; };
  ...
  const initializeServiceAndWaitForLoad = async () => {
  ...
  describe('fixture loading (rawFixtures, loading, error)', () => {
    it('should have loading true initially then false after fixtures load', async () => {
    ...
    describe('fixtures computed signal (with distance)', () => {
      ...
      it('should update distances when homeLocation changes via setPostcode', async () => {
    ...
    describe('setPostcode', () => {
      ...
      it('should update postcode and homeLocation on successful API call and save to local storage', async () => {
      ...
      it('should return null and not update if postcode API fails (e.g., 404)', async () => {
      ...
      it('should return null and not update if postcode API returns invalid data (null result)', async () => {
      ...
      it('should return null and not update if postcode API returns invalid data (missing lat/lng)', async () => {
