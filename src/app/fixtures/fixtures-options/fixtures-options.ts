...
import { GradeFilterDialog } from '../grade-filter-dialog/grade-filter-dialog';
import { FixtureWeekFilter } from './fixture-week-filter';
import { MatCheckboxModule } from '@angular/material/checkbox';
import { Subscription } from 'rxjs';

@Component({
    selector: 'app-fixtures-options',
    templateUrl: './fixtures-options.html',
    styleUrls: ['./fixtures-options.scss'],
    imports: [FlexModule, MatButtonToggleModule, MatIconModule, ExtendedModule, FixtureWeekFilter, MatButtonModule, MatSlideToggleModule, ReactiveFormsModule, MatCheckboxModule],
   changeDetection: ChangeDetectionStrategy.OnPush
})
export class FixturesOptions implements OnInit, OnDestroy {
