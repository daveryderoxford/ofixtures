...
@Component({
   ...
   imports: [MatSidenavModule, RouterOutlet, SidenavMenuComponent],
...
export class AppComponent implements OnInit {
   ...
   private async postcodeWarning() {
      if (!existsInLocalStorage('postCodeWarning') &&
         ...
         const { PostcodeDialogComponent } = await import('./fixtures/postcode/dialog/postcode-dialog/postcode-dialog.component');
