...
@Component({
  ...
  styleUrls: ['./fixture-form.scss'],
  imports: [AppToolbar, FlexModule, ReactiveFormsModule, MatFormFieldModule, MatInputModule, MatSelectModule, MatOptionModule, MatButtonModule, MatDatepickerModule, FormContainer],
  providers: [
