...
@Component({
    ...
    templateUrl: './fixture-selection.dialog.html',
    styleUrls: ['./fixture-selection.dialog.scss'],
...
export class FixtureSelectionDialog implements OnInit {
  fs = inject(FixturesService);

  dialogRef = inject<MatDialogRef<FixtureSelectionDialog, Fixture[]>>(MatDialogRef);
