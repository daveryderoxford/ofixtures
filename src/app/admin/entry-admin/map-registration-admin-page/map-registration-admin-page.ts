...
import { FixtureSelectionDialog } from '../../fixture-selection/fixture-selection.dialog';
import { CourseDialog } from '../course-dialog/course-dialog';
import { Fixture } from 'app/fixtures/@store/fixture';

@Component({
   selector: 'app-map-registration-admin-page',
   templateUrl: './map-registration-admin-page.html',
   styleUrls: ['./map-registration-admin-page.scss'],
   imports: [
      AppToolbar,
      FlexModule,
      MatCardModule,
...
export class MapRegistrationAdminPage implements OnInit {
